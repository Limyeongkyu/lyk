	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>Bo</b>ard</span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>Board</b>LIST</span>
			</a>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<a href="/board/register"> <input type="button" value="글쓰기">
							</a>
							...
							<table class="table table-hover">
									...
									<tr>
										...
										<c:forEach items="${list}" var="vo">
											...
											<th>${vo.bno}</th>
											<th><a
												href="/board/view?bno=${vo.bno}&page=${PageMaker.page}">${vo.title}</a></th>
											<th>${vo.title}</th>
											</tr>
										</c:forEach>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="dataTables_paginate paging_simple_numbers">
									<ul class="pagination">
										<li class="paginate_button previous"><c:if
												test="${PageMaker.prev}">
												<a href="/board/list?page=${PageMaker.startPage-1}"
													>Previous</a>
											</c:if></li>
										<li class="paginate_button active"><c:forEach
												begin="${PageMaker.startPage}" end="${PageMaker.endPage}"
												var="no">
												<a href="/board/list?page=${no}">${no}</a>
											</c:forEach></li>
										<li class="paginate_button next"><c:if
												test="${PageMaker.next}">
